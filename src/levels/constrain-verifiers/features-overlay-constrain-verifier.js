...
export class FeaturesOverlayConstrainVerifier {
    ...
    ;
    checkBoxesOverUse(boxesPosition, heroPosition) {
        if (boxesPosition
    ...
    checkWallsOverUse(output, heroPosition, boxesPosition) {
        output.pointMap
            .get(Tiles.wall)
            .forEach(wall => {
    ...
    checkDuplicateElementsAtSamePosition(output) {
