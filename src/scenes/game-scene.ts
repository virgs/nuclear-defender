...
import {ScreenPropertiesCalculator} from '@/math/screen-properties-calculator';
...
export class GameScene extends Phaser.Scene {
    ...
    public preload() {
        ...
        // this.load.image(configuration.thumbnailTextureKey, configuration.thumbnailTextureFile);
